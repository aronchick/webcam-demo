...
# ///
"""
Motion pipeline - lightweight version for Raspberry Pi.
Uses motion detection instead of pose estimation.
"""
...
def main():
    ...
    print(f"""
{C['bold']}╔═══════════════════════════════════════════════════════════╗
║     MOTION PIPELINE - Lightweight for Raspberry Pi        ║
╚═══════════════════════════════════════════════════════════╝{C['reset']}
""")

    # Use motion detector and motion dashboard
    scripts = [
        ("capture", "capture_video.py"),
        ("process", "process_motion.py"),
        ("dashboard", "dashboard_motion.py"),
    ]
