...
CATEGORIES = {
    "high_motion": {"emoji": "🔥", "color": "#ef4444", "label": "High Motion", "icon": "fire"},
    "medium_motion": {"emoji": "🏃", "color": "#f59e0b", "label": "Medium", "icon": "run"},
    "low_motion": {"emoji": "🚶", "color": "#10b981", "label": "Low Motion", "icon": "walk"},
    "no_motion": {"emoji": "🧘", "color": "#64748b", "label": "Static", "icon": "calm"},
}
...
<body>
    <div class="container">
        <header class="header">
            <div class="logo">
                ...
                <div class="logo-text">
                    <h1>Motion Pipeline</h1>
                    <p>Lightweight motion detection</p>
                </div>
            </div>
        ...
        <footer class="footer">
            Powered by OpenCV · FFmpeg · FastAPI · Expanso
        </footer>
    </div>
    ...
    <script>
        ...
        const categories = {
            high_motion: { emoji: '🔥', color: '#ef4444', label: 'High Motion' },
            medium_motion: { emoji: '🏃', color: '#f59e0b', label: 'Medium' },
            low_motion: { emoji: '🚶', color: '#10b981', label: 'Low Motion' },
            no_motion: { emoji: '🧘', color: '#64748b', label: 'Static' },
        };
